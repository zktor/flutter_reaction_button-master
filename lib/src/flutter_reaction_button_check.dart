...
class _FlutterReactionButtonCheckState
  ...
  void _showReactionButtons(BuildContext context) async {
    ...
    print("siow4u7k");
    print(widget.reactions.length);
    print(reactionButton);
    if (reactionButton != null) _updateReaction(reactionButton[0], reactionButton[1], true);
  }

  void _updateReaction(Reaction? reaction,int index1,
